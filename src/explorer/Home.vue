    ...
    <div class="min-h-screen bg-background">
        ...
        <div class="container mx-auto px-4 py-12">
            <div class="mb-12 max-w-4xl mx-auto text-center">
                <h1 class="text-4xl font-display text-secondary mb-3">Explore Hylé Blockchain</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 border border-white/20">
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs text-neutral">
                            <div>24H Tx: <span class="text-secondary">?</span></div>
                            <div>TPS: <span class="text-secondary">?</span></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 border border-white/20">
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs text-neutral">
                            <div>Avg Time: <span class="text-secondary">?</span></div>
                            <div>Gas: <span class="text-secondary">?</span></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 border border-white/20">
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs text-neutral">
                            <div>24H New: <span class="text-secondary">?</span></div>
                            <div>Active: <span class="text-secondary">?</span></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm p-6 border border-white/20">
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs text-neutral">
                            <div>Validators: <span class="text-secondary">?</span></div>
                            <div>Nodes: <span class="text-secondary">?</span></div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="flex items-center gap-3 text-neutral">
                                                <span
                                                    ...
                                                    <span class="text-secondary">{{
                                                        blockStore.tx_hashes_by_block?.[hash]?.length || "?"
                                                    }}</span></span
                                                >
