...
import NetworkSelector from "@/explorer/NetworkSelector.vue";
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                >
                    ...
                    <span class="text-xl font-display text-secondary">Hylé Explorer</span>
                </RouterLink>
                ...
                <div v-if="!isHomePage" class="flex items-center gap-4 flex-1 max-w-xl mx-4">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            class="w-full bg-white/80 backdrop-blur-sm border border-secondary/10 rounded-xl
                                   py-2 pl-10 pr-4 text-secondary placeholder-neutral/50 text-sm
                                   focus:outline-none focus:ring-2 focus:ring-primary/20 hover:border-secondary/20
